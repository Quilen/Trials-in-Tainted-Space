...
public function initializeMyrellionRooms():void 
{
	...
	rooms["605"].runOnEnter = DMZRandoEventsBonus;
	...
	rooms["GMEREHOSPITAL"] = new RoomClass(this);
	rooms["GMEREHOSPITAL"].roomName = "GILDENMERE\nHOSPITAL";
	...
	rooms["801"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["802"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["804"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["805"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["806"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["807"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["808"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["809"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["810"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["811"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["812"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["813"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["814"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["815"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["817"].eastExit = "FAZIAN_RESCUE_ROOM";
	rooms["817"].westExit = "816";
	rooms["817"].moveMinutes = 2;
	rooms["817"].runOnEnter = kressiaWarehouseExterior;
	rooms["817"].addFlag(GLOBAL.INDOOR);
	rooms["817"].addFlag(GLOBAL.PUBLIC);
	rooms["817"].addFlag(GLOBAL.CAVE);
	
	rooms["FAZIAN_RESCUE_ROOM"] = new RoomClass(this);
	rooms["FAZIAN_RESCUE_ROOM"].roomName = "\nWAREHOUSE";
	rooms["FAZIAN_RESCUE_ROOM"].description = "";
	rooms["FAZIAN_RESCUE_ROOM"].system = "SYSTEM: SINDATHU";
	...
	rooms["818"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["819"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["820"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["821"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["823"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["824"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["825"].runOnEnter = kressiaBasicBonusBitches;
	...
	rooms["830"].runOnEnter = kressiaBasicBonusBitches;
	...
	*************************************/
	...
	//E11 -- Gate Interior
	//No random encounters here! 
	rooms["2E11"] = new RoomClass(this);
	rooms["2E11"].roomName = "GATE\nINTERIOR";
	rooms["2E11"].description = "";
	rooms["2E11"].planet = "PLANET: MYRELLION";
	rooms["2E11"].system = "SYSTEM: SINDATHU";
	rooms["2E11"].northExit = "";
	rooms["2E11"].eastExit = "2G11";
	rooms["2E11"].southExit = "2E13";
	rooms["2E11"].westExit = "";
	rooms["2E11"].moveMinutes = 1;
	rooms["2E11"].runOnEnter = taivrasGateInteriorBonus;
	rooms["2E11"].addFlag(GLOBAL.CAVE);
	rooms["2E11"].addFlag(GLOBAL.INDOOR);

	rooms["2E13"] = new RoomClass(this);
	rooms["2E13"].roomName = "PALACE\nTHOROUGHFARE";
	rooms["2E13"].description = "";
	rooms["2E13"].planet = "PLANET: MYRELLION";
	rooms["2E13"].system = "SYSTEM: SINDATHU";
	rooms["2E13"].northExit = "2E11";
	rooms["2E13"].eastExit = "2G13";
	rooms["2E13"].southExit = "";
	rooms["2E13"].westExit = "2C13";
	rooms["2E13"].moveMinutes = 1;
	rooms["2E13"].runOnEnter = palaceThoroughfareBonus;
	rooms["2E13"].addFlag(GLOBAL.CAVE);
	rooms["2E13"].addFlag(GLOBAL.INDOOR);

	rooms["2G13"] = new RoomClass(this);
	rooms["2G13"].roomName = "ROYAL\nHALLWAY";
	rooms["2G13"].description = "A curving passage connects the entrance hallway to a long, foreboding passage flanked by pillars and fungal lanterns and several large crossed spears set into the stone. An imposing gate stands to the south, made of steel and embossed with a glyph that must symbolize the queen.";
	rooms["2G13"].planet = "PLANET: MYRELLION";
	rooms["2G13"].system = "SYSTEM: SINDATHU";
	rooms["2G13"].northExit = "";
	rooms["2G13"].eastExit = "";
	rooms["2G13"].southExit = "2G15";
	rooms["2G13"].westExit = "2E13";
	rooms["2G13"].moveMinutes = 1;
	rooms["2G13"].runOnEnter = undefined;
	rooms["2G13"].addFlag(GLOBAL.CAVE);
	rooms["2G13"].addFlag(GLOBAL.INDOOR);

	rooms["2G15"] = new RoomClass(this);
	rooms["2G15"].roomName = "ROYAL\nGATEWAY";
	rooms["2G15"].description = "";
	rooms["2G15"].planet = "PLANET: MYRELLION";
	rooms["2G15"].system = "SYSTEM: SINDATHU";
	rooms["2G15"].northExit = "2G13";
	rooms["2G15"].eastExit = "";
	rooms["2G15"].southExit = "2G17";
	rooms["2G15"].westExit = "";
	rooms["2G15"].moveMinutes = 1;
	rooms["2G15"].runOnEnter = gatewayBonusFunc;
	rooms["2G15"].addFlag(GLOBAL.CAVE);
	rooms["2G15"].addFlag(GLOBAL.INDOOR);

	rooms["2G17"] = new RoomClass(this);
	rooms["2G17"].roomName = "THRONE\nSTAIRS";
	...
	rooms["2G17"].moveMinutes = 1;
	rooms["2G17"].runOnEnter = undefined;
	rooms["2G17"].addFlag(GLOBAL.CAVE);
	rooms["2G17"].addFlag(GLOBAL.INDOOR);

	rooms["2E17"] = new RoomClass(this);
	rooms["2E17"].roomName = "THRONE\nROOM";
	rooms["2E17"].description = "";
	rooms["2E17"].planet = "PLANET: MYRELLION";
	rooms["2E17"].system = "SYSTEM: SINDATHU";
	rooms["2E17"].northExit = "";
	rooms["2E17"].eastExit = "2G17";
	rooms["2E17"].southExit = "";
	rooms["2E17"].westExit = "";
	rooms["2E17"].moveMinutes = 1;
	...
	rooms["2C13"].northExit = "2C11";
	rooms["2C13"].eastExit = "2E13";
	rooms["2C13"].southExit = "2C15";
	rooms["2C13"].westExit = "";
	rooms["2C13"].moveMinutes = 1;
	rooms["2C13"].runOnEnter = queensFountainBonusShit;
	rooms["2C13"].addFlag(GLOBAL.CAVE);
	...
	rooms["2C15"].northExit = "2C13";
	rooms["2C15"].eastExit = "";
	rooms["2C15"].southExit = "";
	rooms["2C15"].westExit = "";
	rooms["2C15"].moveMinutes = 1;
	...
	rooms["2C11"].description = "This long, smooth passage is nearly circular in the way it’s been drilled out, suggesting the nyrea put a great deal of time and effort into their construction. A flat walking path connects the fountain chamber south with a curving passage ahead, leading towards a large set of stairs.";
	rooms["2C11"].planet = "PLANET: MYRELLION";
	rooms["2C11"].system = "SYSTEM: SINDATHU";
	rooms["2C11"].northExit = "2C09";
	rooms["2C11"].eastExit = "";
	rooms["2C11"].southExit = "2C13";
	rooms["2C11"].westExit = "";
	rooms["2C11"].moveMinutes = 1;
	rooms["2C11"].runOnEnter = undefined;
	rooms["2C11"].addFlag(GLOBAL.CAVE);
	rooms["2C11"].addFlag(GLOBAL.INDOOR);

	rooms["2C09"] = new RoomClass(this);
	rooms["2C09"].roomName = "\nSTAIRWELL";
	rooms["2C09"].description = "";
	rooms["2C09"].planet = "PLANET: MYRELLION";
	rooms["2C09"].system = "SYSTEM: SINDATHU";
	rooms["2C09"].northExit = "";
	rooms["2C09"].eastExit = "";
	rooms["2C09"].southExit = "2C11";
	rooms["2C09"].westExit = "2A09";
	rooms["2C09"].moveMinutes = 1;
	rooms["2C09"].runOnEnter = taivrasStairwellBonus;
	rooms["2C09"].addFlag(GLOBAL.CAVE);
	rooms["2C09"].addFlag(GLOBAL.INDOOR);

	rooms["2A09"] = new RoomClass(this);
	rooms["2A09"].roomName = "HAREM\nCHAMBER";
	rooms["2A09"].description = "";
	rooms["2A09"].planet = "PLANET: MYRELLION";
	rooms["2A09"].system = "SYSTEM: SINDATHU";
	rooms["2A09"].northExit = "";
	rooms["2A09"].eastExit = "2C09";
	rooms["2A09"].southExit = "";
	rooms["2A09"].westExit = "";
	rooms["2A09"].moveMinutes = 1;

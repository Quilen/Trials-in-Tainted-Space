package classes.Characters 
{
	...
	public class crtNyreanHuntresses extends Creature
	{
		
		public function crtNyreanHuntresses() 
		{
			this._latestVersion = 1;
			this.version = this._latestVersion;
			this._neverSerialize = true; // Setting this will stop a given NPC class from ever being serialized.
			
			this.short = "nyrean huntresses";
			...
			this.long = "Your nyrea huntresses are carrying spears and wearing chainmail. They stay in formation, forming a pointy wall of death.";
